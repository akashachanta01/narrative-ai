...
function InsightCard({
  ...
  const { context, action } = parseNarrative(displayNarrative);
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <div className="flex items-center gap-2">
              ...
              {action && (
                <Button
                  size="sm"
                  className="h-7 px-3 text-[11px] font-semibold gap-1.5 bg-primary text-primary-foreground hover:bg-primary/90"
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-sm text-muted-foreground pt-1">
              Based on your {insight.metric.toLowerCase()} data
            </DialogDescription>
          </DialogHeader>
          <div className="rounded-xl bg-primary/5 border border-primary/10 p-4 mt-2">
            <p className="text-sm font-medium text-foreground leading-relaxed">{action}</p>
          </div>
        </DialogContent>
      </Dialog>
    </>
